...
const LogoHTML = (props) => <svg viewBox="0 0 512 512" className="logos" data-presentation="I am proficient in HTML" onMouseEnter={props.onMouseEnter} onMouseLeave={props.onMouseLeave} data-name="HTML" style={{ scale: "1.5" }}>
