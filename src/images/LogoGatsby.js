...
const LogoGatsby = (props) => <svg viewBox="0 0 28 28" className="logos" data-presentation="I am a fan of Gatsby JS and all the possibilities it offers when combined with Firebase, AWS or APIs" onMouseEnter={props.onMouseEnter}>
