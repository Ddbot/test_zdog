    ...
    <>
		<div className="slide text" onMouseMove={props.onMouseMove}>
		    <p>
                ...
                <span style={{ backgroundColor: "rebeccapurple", padding: "6px", color: "white" }}><b>modernes, rapides</b></span> et <span style={{ backgroundColor: "rebeccapurple", padding: "6px", color: "white" }}><b>élégants</b></span>.
			</p>
        </div>
    </>
  );
