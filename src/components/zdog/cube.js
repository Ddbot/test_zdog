...
const Cube = (props) => {
    ...
    return (<svg id="cube" viewBox="0 0 559 538" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd" strokeLinejoin="round">
        ...
        {/* <g id="triangles">
            ...
            <path d="M453.01 483.37l-186-107.39v214.77l186-107.38z" fill="hsla(45, 81%, 77%,1)" stroke="hsla(45, 81%, 77%,1)" strokeWidth=".15"/>
            <path d="M267.01 375.98l186 107.39V268.59l-186 107.39z" fill="#f4d193" stroke="#f4d193" strokeWidth=".15"/>
            <path d="M453.01 268.61l-186-107.38V376l186-107.39z" fill="hsla(32, 82%, 76%,1)" stroke="hsla(32, 82%, 76%,1)" strokeWidth=".15"/>
        ...
        <g id="facades" strokeWidth=".15">
            ...
            <path d="M267 161.22v214.75l.03.03L453 483.38V268.63h-.03L267 161.22z" fill="hsla(32, 82%, 76%,1)" stroke="hsla(32, 82%, 76%,1)" />
