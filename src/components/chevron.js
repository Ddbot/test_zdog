...
const Chevron = (props) => {
    ...
    return (<button className="chevronContainer" onClick={props.onClick} onKeyPress={props.onClick} role={'button'} tabIndex={0}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 455 455" {...props} onKeyPress={handleKeyPress}fill='rebeccapurple'>
